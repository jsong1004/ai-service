        ...
        <Card className="max-w-4xl mx-auto p-8">
          ...
          <div className="space-y-6 text-gray-700">
            <section>
              ...
              <p>
                Welcome to Startup Consulting Inc. These Terms of Service ("Terms") govern your access to and use of our website, 
            ...
            <section>
              ...
              <p>
                Our Services are designed to provide information about our AI business automation consulting and related services. 
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li>Attempt to interfere with or compromise the system integrity or security of our Services</li>
            ...
            <section>
              ...
              <p>
                ...
                Startup Consulting Inc., its licensors, or other providers of such material and are protected by copyright, 
            ...
            <section>
              <h2 className="text-xl font-semibold mb-3">User Contributions</h2>
              <p>
                Our Services may contain message boards, chat rooms, personal profiles, forums, or other interactive features 
                (collectively, "Interactive Services") that allow users to post, submit, publish, display, or transmit content 
                or materials (collectively, "User Contributions") on or through the Services.
              </p>
              <p className="mt-2">
                All User Contributions must comply with the Content Standards set out in these Terms. Any User Contribution you 
                post to the site will be considered non-confidential and non-proprietary. By providing any User Contribution, 
                you grant us and our affiliates and service providers the right to use, reproduce, modify, perform, display, 
            ...
            <section>
              ...
              <p>
                ...
                EITHER EXPRESS OR IMPLIED. NEITHER STARTUP CONSULTING INC. NOR ANY PERSON ASSOCIATED WITH STARTUP CONSULTING INC. 
                MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, 
            ...
            <section>
              ...
              <p>
                IN NO EVENT WILL STARTUP CONSULTING INC., ITS AFFILIATES OR THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, 
                AGENTS, OFFICERS, OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER ANY LEGAL THEORY, ARISING OUT OF OR 
                IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE SERVICES, ANY WEBSITES LINKED TO IT, ANY CONTENT ON 
                THE SERVICES OR SUCH OTHER WEBSITES OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE SERVICES OR SUCH OTHER WEBSITES.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p>
                You agree to defend, indemnify, and hold harmless Startup Consulting Inc., its affiliates, licensors, and service 
            ...
            <section>
              ...
              <p>
                ...
                shall be governed by and construed in accordance with the laws of the State of Wa, without giving effect 
              ...
              <p className="mt-2">
                ...
                instituted exclusively in the federal courts of the United States or the courts of the State of Washington, 

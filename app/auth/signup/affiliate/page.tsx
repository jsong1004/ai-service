...
export default function AffiliateSignupPage() {
  ...
  const handleGoogleSignup = () => {
    ...
    sessionStorage.setItem('signupRole', 'affiliate')
    signIn('google', { callbackUrl: '/dashboard/affiliate' })
  }
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              <CardTitle className="text-2xl font-bold">Create Affiliate Account</CardTitle>
              <CardDescription>
                Start earning commissions by referring clients
              </CardDescription>
            </div>
          </div>
        </CardHeader>
